 ...
 * @author MSI
 */
public class prodlist extends BaseForm {

    public prodlist(Resources res) {
        super(BoxLayout.y());
    ...
    private void addButton(Prod o, Resources res) {
        ...
        supp.addActionListener(e -> {
            ...
            try {
                ...
                refreshTheme();
                Dialog.show("Supprimé", "produit supprimé avec succès!", new Command("OK"));
