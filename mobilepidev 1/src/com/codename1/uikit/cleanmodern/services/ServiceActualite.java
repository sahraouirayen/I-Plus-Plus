...
//            Logger.getLogger(ServiceOeuvre.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public ArrayList<Actualite> getAllOeuvres() {
        String url = Statics.BASE_URL + "actt/AllActualite";
        req.setUrl(url);
        req.setPost(false);
    ...
    public void Supprimer(int id) {
        ...
        con.setUrl(Statics.BASE_URL  + "deleteActualitejson/" + id);
        con.setPost(false);
    ...
    public boolean addAct(TextField titreActualite, TextField description, TextField etendu, TextField imageAct) {
        ...
        String url = Statics.BASE_URL  + "AddActualitejson/new?titreActualite=" + titreActualite.getText() + "&description=" + description.getText() + "&etendu=" + etendu.getText() + "&imageAct=" + imageAct.getText();
        req.setUrl(url);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
    ...
    public boolean updateAct(TextField titreActualite, TextField description, TextField etendu, TextField imageAct, int idActualite) {
        ...
        String url = Statics.BASE_URL  + "UpdateActualitejson/" + idActualite + "/edit?titreActualite=" + titreActualite.getText() + "&description=" + description.getText() + "&etendu=" + etendu.getText() + "&imageAct=" + imageAct.getText();
        req.setUrl(url);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
