...
import com.codename1.myapp.Services.ServiceActualite;
/**
 *
 * @author sahra
 */
public class EditActualiteForm extends BaseForm {

    public EditActualiteForm(Form previous,Resources res,int id) {
        ...
        TextField tftitreact = new TextField(""," titre actualite ");
             ...
             public void actionPerformed(ActionEvent evt) {
                 if ((tftitreact.getText().length()==0)||(tfdesc.getText().length()==0)||(tfetendu.getText().length()==0)||(tfimg.getText().length()==0))
                    ...
                    try {
                        ...
                        if(ServiceActualite.getInstance().updateAct(tftitreact, tfdesc,tfetendu,tfimg,id))
