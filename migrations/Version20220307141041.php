 ...
 */
final class Version20220307141041 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie_produit CHANGE nom_cat_prod nom_cat_prod VARCHAR(30) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE type_reclamation CHANGE niveau niveau VARCHAR(60) NOT NULL COLLATE `utf8mb4_unicode_ci`');
