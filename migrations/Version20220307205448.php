 ...
 */
final class Version20220307205448 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prod ADD quantite INT DEFAULT NULL');
    }
