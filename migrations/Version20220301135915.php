 ...
 */
final class Version20220301135915 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE actualite CHANGE titre_actualite titre_actualite VARCHAR(30) NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE description description VARCHAR(255) NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE image_act image_act VARCHAR(255) NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE comment_act comment_act VARCHAR(100) NOT NULL COLLATE `utf8mb4_general_ci`');
