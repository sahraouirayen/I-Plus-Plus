...
class ReservationController extends AbstractController
{
    ...
    /**
     * @Route("/new/{idevent}/{idUser}", name="app_reservation_new", methods={"GET", "POST"})
     */
    public function new(Request $request,$idevent,$idUser, EntityManagerInterface $entityManager): Response
    {
