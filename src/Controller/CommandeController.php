...
class CommandeController extends AbstractController
{
     ...
     */
    public function success(SessionInterface $session, ProdRepository $productRepository,UserRepository  $userRepository )
    {
        ...
        foreach ($panier as $id => $quantity){
            ...
            $total += $produit->getPrixProd() * $quantity;
        }
        $order=new Commande();
        ...
        foreach ($panierWithData as $item) {
            ...
            $productOrder->setPrice($productRepository->find($item['produit'])->getPrixProd()*$item['quantite']);
     ...
     */
    public function index(CommandeRepository $commandeRepository,Request $request ,LigneCommandeRepository $ligneCommandeRepository): Response
    {/*
        if($request->isMethod("GET"))
        {
            $id = $request->get("id");
            $lignesCommandes=$this->getDoctrine()->getRepository(LigneCommande::class)->find($id);
