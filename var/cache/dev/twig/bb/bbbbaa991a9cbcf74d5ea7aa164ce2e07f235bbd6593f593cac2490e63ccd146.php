...
class __TwigTemplate_8aefb1a55b3140911877485bebd9350406203a7d94ed36d71c98bf3960ef9ec6 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 2
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 2, $this->source); })()), 'widget', ["attr" => ["class" => "form-group"]]);
        echo "
...
{{ form_end(form) }}
", "evenement/_form.html.twig", "C:\\Users\\21695\\Documents\\I-Plus-Plus\\templates\\evenement\\_form.html.twig");
    }
}
