...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.yisuUJe' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_YisuUJeService()
    {
        return $this->privates['.service_locator.yisuUJe'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Controller\\ActualiteController::index' => ['privates', '.service_locator.XrRqEPw', 'get_ServiceLocator_XrRqEPwService', false],
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.yisuUJe'] ?? $this->get_ServiceLocator_YisuUJeService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder67ddf = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializeref811 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties1fe71 = [
        
    ];

    public function getConnection()
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'getConnection', array(), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'getMetadataFactory', array(), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'getExpressionBuilder', array(), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'beginTransaction', array(), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->beginTransaction();
    }

    public function getCache()
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'getCache', array(), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->getCache();
    }

    public function transactional($func)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'transactional', array('func' => $func), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'wrapInTransaction', array('func' => $func), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'commit', array(), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->commit();
    }

    public function rollback()
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'rollback', array(), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'getClassMetadata', array('className' => $className), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'createQuery', array('dql' => $dql), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'createNamedQuery', array('name' => $name), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'createQueryBuilder', array(), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'flush', array('entity' => $entity), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'clear', array('entityName' => $entityName), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->clear($entityName);
    }

    public function close()
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'close', array(), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->close();
    }

    public function persist($entity)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'persist', array('entity' => $entity), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'remove', array('entity' => $entity), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'refresh', array('entity' => $entity), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'detach', array('entity' => $entity), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'merge', array('entity' => $entity), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'getRepository', array('entityName' => $entityName), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'contains', array('entity' => $entity), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'getEventManager', array(), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'getConfiguration', array(), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'isOpen', array(), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'getUnitOfWork', array(), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'getProxyFactory', array(), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'initializeObject', array('obj' => $obj), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'getFilters', array(), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'isFiltersStateClean', array(), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'hasFilters', array(), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return $this->valueHolder67ddf->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializeref811 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder67ddf) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder67ddf = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder67ddf->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, '__get', ['name' => $name], $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        if (isset(self::$publicProperties1fe71[$name])) {
            return $this->valueHolder67ddf->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder67ddf;
    ...
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, '__set', array('name' => $name, 'value' => $value), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;
    ...
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, '__isset', array('name' => $name), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;
    ...
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, '__unset', array('name' => $name), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;
    ...
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, '__clone', array(), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        $this->valueHolder67ddf = clone $this->valueHolder67ddf;
    }

    public function __sleep()
    {
        $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, '__sleep', array(), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;

        return array('valueHolder67ddf');
    }
    ...
    {
        $this->initializeref811 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializeref811;
    }

    public function initializeProxy() : bool
    {
        return $this->initializeref811 && ($this->initializeref811->__invoke($valueHolder67ddf, $this, 'initializeProxy', array(), $this->initializeref811) || 1) && $this->valueHolder67ddf = $valueHolder67ddf;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder67ddf;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder67ddf;
    }
}
